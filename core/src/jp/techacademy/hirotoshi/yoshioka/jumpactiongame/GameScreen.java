...
public class GameScreen extends ScreenAdapter {
    ...
    int mScore; // ←追加する
    int mHighScore; // ←追加する
    Preferences mPrefs; //added
    Sound sound = Gdx.audio.newSound(Gdx.files.internal("sound.mp3")); //sound追加
    ...
    private void createStage() {
        ...
        // StepとStarをゴールの高さまで配置していく + Enemy
        float y = 0;
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.6f) {
                ...
                enemy.setPosition(step.getX() + mRandom.nextFloat(), step.getY() + Enemy.ENEMY_HEIGHT + mRandom.nextFloat() * 10);
                mEnemies.add(enemy);
            }
